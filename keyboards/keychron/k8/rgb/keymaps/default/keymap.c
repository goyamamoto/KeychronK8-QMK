...
*/
    ...
    [1] = LAYOUT_tkl_ansi(
        ...
        _______, BT_PRF1, BT_PRF2, BT_PRF3, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     RM_SPDU, RM_SATU, RM_HUEU,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     RM_SPDD, RM_SATD, RM_HUED,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, K8_BATT, _______, _______, _______, _______, _______,          _______,                       RM_VALU,
